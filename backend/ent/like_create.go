...
func (_c *LikeCreate) SetUserID(v int64) *LikeCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetPostID sets the "post_id" field.
func (_c *LikeCreate) SetPostID(v int64) *LikeCreate {
...
func (_c *LikeCreate) SetID(v int64) *LikeCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *LikeCreate) SetPost(v *Post) *LikeCreate {
...
func (_c *LikeCreate) createSpec() (*Like, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(like.Table, sqlgraph.NewFieldSpec(like.FieldID, field.TypeInt64))
	)
